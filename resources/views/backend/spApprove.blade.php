            ...
            @if(isset($spRegisterProfile))
                <div class="card card-widget widget-user-2 mb-5">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item p-2">
                                National Id Number <span
                                        class="float-right"><?php echo getIdByName($spRegisterProfile->user_id, "user_informations", "user_id", "nationalId_Number");?></span>
                            </li>
                            <li class="nav-item p-2">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{url('AdminSPUpdate?updateB='.$spRegisterProfile->id)}} " class="btn btn-danger notApproveAlert">Not
                            Approve</a>
                    </div>
                </div>
            @endif
                        ...
                        @foreach($sp_register as $sp_registers)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('spApprove')}}/{{$sp_registers->id}}"
