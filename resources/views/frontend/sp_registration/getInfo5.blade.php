...
@section('content')
    ...
    <section class="bg-light mb-5 pt-5" id="getInfo">
        ...
        <div id="topNavigator" class="mt-4 pl-5 w-100">
            <ul class="justify-content-center">
                ...
                <li class="pointer pointer5"><a href="{{route('getInfo5')}}" class="text-white">অ্যাড রিসোর্স
                    </a></li>
            </ul>
        </div>
        ...
        <div class="container bg-white py-3">
            ...
            <h4 class="font-weight-normal text-center my-5"> অ্যাড রিসোর্স </h4>
            <form method="post" action="{{url('updateGetInfo5')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="hidden" name="id" value="">
                <div class="row justify-content-center">
                    <div class="col-3 m-1 text-right">
                        Are you a SP or freelancer
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input class="form-check-input" id="credit" onchange="resourceAdd('hide')" name="resource_type" value="1"
                                   type="radio" required>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" id="debit" onchange="resourceAdd('show')" name="resource_type" value="2" type="radio" checked required>
                ...
                <div class="mt-3" id="resourceList">
                    ...
                    <div class="row justify-content-center my-4">
                        ...
                        <div class="col-3">
                            <button type="button" onclick="chooseFile3()" class="btn btn-secondary">ছবি আপলোড করুন
                            </button>
                ...
                <div class="row justify-content-center my-4">
                    ...
                    <div class="col-3">
                        <button type="submit" name="submit" value="again" class="btn btn-success" id="spSubmitButton">জমা দিন</button>


                    </div>
                </div>
                <button type="submit" name="submit" value="done" class="btn btn-success float-right">Preview registration</button>
            </form>
